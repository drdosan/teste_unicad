...
$.fn.position = function( options ) {
	...
	// Verifica se targetSelector é uma string segura e não contém caracteres perigosos
	if (typeof targetSelector === 'string' && /^[a-zA-Z0-9\-_#.\s]+$/.test(targetSelector)) {
		var target = $(targetSelector);
	} else {
		console.warn("Seletor inválido fornecido.");
		var target = null; // ou uma ação de fallback apropriada
	}

	// Obter informações sobre a área de posicionamento e rolagem
...
$.widget( "ui.tabs", {
	...
	_sanitizeSelector: function (hash) {
		return hash ? hash.replace(/[^a-zA-Z0-9\-_]/g, "\\$&") : "";
	},
