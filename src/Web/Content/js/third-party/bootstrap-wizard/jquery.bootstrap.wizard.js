...
var bootstrapWizardCreate = function(element, options) {
	...
	this.fixNavigationButtons = function() {
		...
		var safeSelector = $settings.previousSelector.replace(/[^a-zA-Z0-9-_#\.\s]/g, '');
		$(safeSelector, element).toggleClass('disabled', (obj.firstIndex() >= obj.currentIndex()));

		// Sanitização do seletor para evitar injeção
		var safeNextSelector = $settings.nextSelector.replace(/[^a-zA-Z0-9-_#\.\s]/g, '');
		$(safeNextSelector, element).toggleClass('disabled', (obj.currentIndex() >= obj.navigationLength()));

		// Sanitização do seletor para evitar injeção
		var safeNextSelector = $settings.nextSelector.replace(/[^a-zA-Z0-9-_#\.\s]/g, '');
		obj.rebindClick($(safeNextSelector, element), obj.next);

		// Sanitização do seletor para evitar injeção
		var safePreviousSelector = $settings.previousSelector.replace(/[^a-zA-Z0-9-_#\.\s]/g, '');
		obj.rebindClick($(safePreviousSelector, element), obj.previous);

		// Sanitização do seletor para evitar injeção
		var safeLastSelector = $settings.lastSelector.replace(/[^a-zA-Z0-9-_#\.\s]/g, '');
		obj.rebindClick($(safeLastSelector, element), obj.last);

		// Sanitização do seletor para evitar injeção
		var safeFirstSelector = $settings.firstSelector.replace(/[^a-zA-Z0-9-_#\.\s]/g, '');
		obj.rebindClick($(safeFirstSelector, element), obj.first);
