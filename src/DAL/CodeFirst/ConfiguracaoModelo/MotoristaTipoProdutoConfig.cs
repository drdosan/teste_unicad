...
{
    public class MotoristaTipoProdutoConfig : EntityTypeConfiguration<MotoristaTipoProduto>
    {
        public MotoristaTipoProdutoConfig()
        {
            this.ToTable("MotoristaTipoProduto");
