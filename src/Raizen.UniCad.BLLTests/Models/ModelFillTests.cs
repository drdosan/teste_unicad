...
namespace Raizen.UniCad.BLLTests
{
    ...
    public class ModelFillTests
    {
        ...
        [TestMethod]
        public void MotoristaDocumentoViewEmailEnviarTest()
        {
            ...
            #region Cenários
            var cenarios = new List<MotoristaDocumentoViewEmailEnviarTest_Cenario>()
            {
                new MotoristaDocumentoViewEmailEnviarTest_Cenario("FOB", "motorista@email.com", "transportadora@email.com", "motorista@email.com"),
                new MotoristaDocumentoViewEmailEnviarTest_Cenario("CIF", "motorista@email.com", "transportadora@email.com", "transportadora@email.com")
            }; 
            #endregion
            ...
            foreach (var c in cenarios)
            {
                ...
                {
                    Operacao = c.Operacao,
                    Email = c.EmailMotorista,
                    EmailTransportadora = c.EmailTranportadora
                };
                ...
                //Assert
                Assert.AreEqual(c.EmailEsperado, emailAtual); 
            }
        }

        private class MotoristaDocumentoViewEmailEnviarTest_Cenario
        {
            public MotoristaDocumentoViewEmailEnviarTest_Cenario(string operacao, string emailMotorista, string emailTranportadora, string emailEsperado)
            {
                Operacao = operacao;
                EmailMotorista = emailMotorista;
                EmailTranportadora = emailTranportadora;
                EmailEsperado = emailEsperado;
            }

            public string Operacao { get; set; }
            public string EmailMotorista { get; set; }
            public string EmailTranportadora { get; set; }
            public string EmailEsperado { get; set; }
        }

        [TestMethod]       
        public void MotoristaDocumentoViewDocumentoIdentificacaoTest()
        {
            /* Foi acordado junto ao time de arquitetura da Raizen o uso desta abordagem dos cenários abaixo,
              visto que o Jenkins da Raizen não aceita o uso do atributo [DataRows()] nos testes */
            #region Cenários
            var cenarios = new List<MotoristaDocumentoViewDocumentoIdentificacaoTest_Cenario>()
            {
                new MotoristaDocumentoViewDocumentoIdentificacaoTest_Cenario(EnumPais.Brasil, "cpf287", "dni345", "cpf287"),
                new MotoristaDocumentoViewDocumentoIdentificacaoTest_Cenario(EnumPais.Argentina, "cpf287", "dni345", "dni345")
            }; 
            #endregion
            ...
            foreach (var c in cenarios)
            {
                ...
                //Assert
                Assert.AreEqual(c.DocumentoEsperado, documentoAtual); 
            }
        }

        private class MotoristaDocumentoViewDocumentoIdentificacaoTest_Cenario
        {
            public MotoristaDocumentoViewDocumentoIdentificacaoTest_Cenario(EnumPais pais, string cpf, string dni, string documentoEsperado)
            {
                Pais = pais;
                Cpf = cpf;
                Dni = dni;
            ...
            public string DocumentoEsperado { get; set; }
        }
        ...
        [TestMethod]
        public void PlacaDocumentoViewEmailEnviarTest()
        {
            /* Foi acordado junto ao time de arquitetura da Raizen o uso desta abordagem dos cenários abaixo,
              visto que o Jenkins da Raizen não aceita o uso do atributo [DataRows()] nos testes */
            #region Cenários
            var cenarios = new List<PlacaDocumentoViewEmailEnviarTest_Cenario>()
            {
                new PlacaDocumentoViewEmailEnviarTest_Cenario("FOB", EnumEmpresa.EAB, "fob@email.com", "cif@email.com", "ambos@email.com", "fob@email.com"),
                new PlacaDocumentoViewEmailEnviarTest_Cenario("FOB", EnumEmpresa.Combustiveis, "fob@email.com", "cif@email.com", "ambos@email.com", "fob@email.com"),
                new PlacaDocumentoViewEmailEnviarTest_Cenario("FOB", EnumEmpresa.Ambos, "fob@email.com", "cif@email.com", "ambos@email.com", "fob@email.com"),
                new PlacaDocumentoViewEmailEnviarTest_Cenario("CIF", EnumEmpresa.EAB, "fob@email.com", "cif@email.com", "ambos@email.com", "cif@email.com"),
                new PlacaDocumentoViewEmailEnviarTest_Cenario("CIF", EnumEmpresa.Combustiveis, "fob@email.com", "cif@email.com", "ambos@email.com", "cif@email.com"),
                new PlacaDocumentoViewEmailEnviarTest_Cenario("CIF", EnumEmpresa.Ambos, "fob@email.com", "cif@email.com", "ambos@email.com", "ambos@email.com"),
            }; 
            #endregion
            ...
            foreach (var c in cenarios)
            {
                ...
                {
                    Operacao = c.Operacao,
                    IdEmpresa = (int)c.Empresa,
                    Email = c.EmailFOB,
                    EmailCif = c.EmailCIF,
                    EmailEmpresaAmbos = c.EmailAMBOS
                };
        ...
        private class PlacaDocumentoViewEmailEnviarTest_Cenario
        {
            public PlacaDocumentoViewEmailEnviarTest_Cenario(string operacao, EnumEmpresa empresa, string emailFOB, string emailCIF, string emailAMBOS, string emailEsperado)
            {
                Operacao = operacao;
                Empresa = empresa;
                EmailFOB = emailFOB;
                EmailCIF = emailCIF;
                EmailAMBOS = emailAMBOS;
                EmailEsperado = emailEsperado;
            }

            public string Operacao { get; set; }
            public EnumEmpresa Empresa { get; set; }
            public string EmailFOB { get; set; }
            public string EmailCIF { get; set; }
            public string EmailAMBOS { get; set; }
            public string EmailEsperado { get; set; }
        }
        ...
        [TestMethod]
        public void DescricaoPorLinguaAttributeTest()
        {
            bool gerarHttpContext;
            bool adicionaCookie;
            string msgPortugues;
            string msgEspanhol;
            string idioma;
            string msgEsperada;
            DescricaoPorLinguaAttribute model;

            #region Cenario 1
            //Arrange
            gerarHttpContext = true;
            adicionaCookie = true;
            msgPortugues = "Mensagem em português";
            msgEspanhol = "Mensaje en español";
            idioma = "pt-BR";
            msgEsperada = "Mensagem em português";
            ...
            //Act
            model = new DescricaoPorLinguaAttribute(msgPortugues, msgEspanhol);
            ...
            msgEspanhol = "Mensaje en español";
            idioma = "es-AR";
            msgEsperada = "Mensaje en español";
