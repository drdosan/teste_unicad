...
namespace Raizen.UniCad.BLLTests
{
    ...
    public class MotoristaDocumentoBusinessTests : BaseTest
    {
        ...
        private Mock<IMotoristaBusiness> motoristaBusiness;
        ...
        public void InicializarTeste()
        {
            ...
            motoristaBusiness = new Mock<IMotoristaBusiness>();
        ...
        [TestMethod()]
        public void ProcessarDocumentosVencidosTest_BloqueioImediato_Success_WithSentEmail()
        {
            ...
            var documentos = new List<MotoristaDocumentoView>()
            {
                new MotoristaDocumentoView()
                {
                    ...
                    EmailTransportadora = "emailtransp@empresa.com.br",
                    QtdeAlertas = 1
                }
            };
        ...
        [TestMethod()]
        public void ProcessarDocumentosVencidosTest_BloqueioImediato_Success_OneWithSentEmail_OtherWihoutSentEmail()
        {
            var dataExecucao = DateTime.Now.Date;
            ...
            var motoristaDocumento1 = new MotoristaDocumento()
            {
                ID = 1,
                Alerta1Enviado = false
            };

            var motoristaDocumento2 = new MotoristaDocumento()
            {
                ID = 2,
                Alerta1Enviado = false
            };
            ...
            motoristaDocumentoRepository.Setup(s => s.GetDocumentosBloqueados(dataExecucao)).Returns(documentos);
            motoristaDocumentoRepository.Setup(s => s.Selecionar(documentos[0].ID)).Returns(motoristaDocumento1);
            motoristaDocumentoRepository.Setup(s => s.Selecionar(documentos[1].ID)).Returns(motoristaDocumento2);
            configBusiness.Setup(s => s.GetConfigInt(EnumConfig.habilitarVectoMotorista, It.IsAny<int>())).Returns(-1);
            configBusiness.Setup(s => s.GetConfigInt(EnumConfig.habilitarBloqueioDocMotorista, It.IsAny<int>())).Returns(-1);
            ...
            Assert.IsTrue(documentos[0].TipoAlerta == 1);
            Assert.IsTrue(documentos[0].Enviado);
            Assert.IsTrue(motoristaDocumento1.Vencido);
            Assert.IsTrue(motoristaDocumento1.Bloqueado);
            Assert.IsTrue(motoristaDocumento1.Processado);

            Assert.IsTrue(documentos[1].TipoAlerta == 1);
            Assert.IsFalse(documentos[1].Enviado);
            Assert.IsTrue(motoristaDocumento2.Vencido);
            Assert.IsTrue(motoristaDocumento2.Bloqueado);
            Assert.IsTrue(motoristaDocumento2.Processado);
        }
        ...
        public void ProcessarAlertaDocumentosComposicao_QtdeAlertasZerado_WithoutSentEmail()
        {
            ...
            Assert.IsTrue(retorno == 0);
            Assert.IsFalse(motoristaDocumento.Alerta1Enviado);
            Assert.IsFalse(motoristaDocumento.Alerta2Enviado);
            Assert.IsFalse(documentos[0].Enviado);
        }
