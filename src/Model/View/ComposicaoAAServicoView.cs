...
{
    public class ComposicaoAAServicoView
    {
        [IgnoreDataMember]
        ...
        public PlacaAAServicoView PlacaCavaloTruck { get; set; }
        public PlacaAAServicoView PlacaCarreta1 { get; set; }
        public PlacaAAServicoView PlacaDollyCarreta2 { get; set; }
        public PlacaAAServicoView PlacaCarreta2 { get; set; }
